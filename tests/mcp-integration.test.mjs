...
test('GitHub Projects MCP calls every tool and reads every resource', async () => {
  ...
  try {
    const calls = [
      ...
      ['getProjectFields', {}],
      ['updateProjectField', { project_id: 'PVT_1', item_id: 'PVTI_1', field_id: 'FIELD_1', value: { text: 'In progress' } }],
      ...
      ['manageItemDependencies', { project_id: 'PVT_1', item_id: 'PVTI_1', dependencies: { blocks: ['PVTI_2'] } }],
